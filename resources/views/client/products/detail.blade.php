        ...
        <div class="row px-xl-5">
            ...
            <div class="col-lg-7 pb-5">
                ...
                @if ($product->details->count() > 0)
                    ...
                    <form id="formAddCart" method="post" action="{{ route('client.carts.add') }}">
                        @csrf
                        <div class="d-flex mb-4">
                            ...
                            @foreach ($product->details as $size)
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" class="custom-control-input" id="color->{{ $size->size }}"
                                        name="product_size" value="{{ $size->size }}">
                                    <label class="custom-control-label"
                                        for="color->{{ $size->size }}">{{ $size->size }}</label>
                                </div>
                            @endforeach
                        ...
                        <div class="d-flex align-items-center mb-4 pt-2">
                            <div class="input-group quantity mr-3" style="width: 130px;">
                                ...
                                <input type="text" name="product_quantity" class="form-control bg-secondary text-center"
                                    value="1">
                                <div class="input-group-btn">
                            ...
                            <button class="btn btn-primary px-3 btn-add-to-cart" type="submit"><i
